...
参照元: `docs/specs/events/20260818_144847_spec_generation/_cross-cutting/ux-ui/common-components.md`（共通状態表示パターン）
...
Feature: ハング疑い・異常の通知を確認する - tier-worker
  ...
  Scenario: 通知済みのハング検知記録を検知日時降順で表示する
    ...
    And run_id "3f8c9d2e-5b41-4a7e-9c13-6d2a8b0f1e57" のハング検知記録（detected_at "2026-08-18T09:35:00+09:00"、notified_at "2026-08-18T09:36:00+09:00"）と run_id "c41d7e08-2b95-4f36-a8d1-5e7c93b204af" のハング検知記録（detected_at "2026-08-18T10:04:00+09:00"、notified_at "2026-08-18T10:05:00+09:00"）が存在する
    When 運用者が"relaygate hang-watch notice"を実行する
    Then 標準出力に run_id "c41d7e08-2b95-4f36-a8d1-5e7c93b204af" の検知記録が先、run_id "3f8c9d2e-5b41-4a7e-9c13-6d2a8b0f1e57" の検知記録が後の順で表示され終了コード0で完了する
```
