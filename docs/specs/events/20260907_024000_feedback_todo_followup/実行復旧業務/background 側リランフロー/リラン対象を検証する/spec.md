...
| リラン対象 role | rapid-crosscheck | 元 run の速報比較依頼が SUCCEEDED / FAILED / ABORTED(abort-blue / abort-green による未着手依頼の中止を含む)なら可。RUNNING / CLAIMED / REQUESTED は不可 | tier-ops | domain `is_rerunnable` |
