...
Feature: 確報比較依頼を claim する
  ...
  Scenario: REQUESTED の依頼を claim する(SPEC-006-02)
    Given final_crosscheck_requests に final_crosscheck_id=20260830T210000-final-7b2c9e1f status=REQUESTED requested_at=2026-08-30T21:00:00Z の行がある
    ...
    Then 実行ログに "INFO claimed final_crosscheck_id=20260830T210000-final-7b2c9e1f worker_id=final-worker-01 lease_until=2026-08-30T21:10:30Z" が残る
