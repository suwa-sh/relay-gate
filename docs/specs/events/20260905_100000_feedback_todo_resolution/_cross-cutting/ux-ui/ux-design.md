...
- **日時**: stdout / stderr / ログ / メール本文の日時は UTC ISO 8601(`2026-08-30T11:30:00Z`)に統一し、ローカル時刻を混在させない。例外は run_id / final_crosscheck_id の時刻部だけ(ホストのローカルタイムゾーン、`Z` 無し。`ui-design.md`「出力フォーマット」)
