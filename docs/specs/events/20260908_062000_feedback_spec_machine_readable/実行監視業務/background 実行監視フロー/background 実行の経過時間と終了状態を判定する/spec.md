...
|--------|---------|------------------|
| REQ-008 | SPEC-008-01 | 上限超過をハング疑いと判定する(SPEC-008-01) / 上限内は継続監視と判定する(SPEC-008-01) / 非 0 終了を実行エラーと判定する(SPEC-008-01) / 0 終了は通知対象外(SPEC-008-01) |
| REQ-008 | SPEC-008-02 | FAILED の速報比較依頼を比較異常と判定する(SPEC-008-02) / ハング疑い通知後の速報比較依頼も再判定する(SPEC-008-02) |
