...
Feature: ハング疑い・異常を運用者へ通知する - tier-worker
  ...
  Scenario: 未通知のハング検知記録をbannerで通知しnotified_atを更新する
    ...
    And detection_id "b83f4d15-6c92-4e07-a5b8-3d19f7c04e2a" のハング検知記録が run_id "3f8c9d2e-5b41-4a7e-9c13-6d2a8b0f1e57"、detection_type "ハング疑い"、notified_at未設定で存在する
    When CronJobが異常通知バッチを起動する
    Then HangDetectionNotice（banner）が run_id "3f8c9d2e-5b41-4a7e-9c13-6d2a8b0f1e57"、異常検知種別 "ハング疑い" を含めて標準出力に表示され、notified_atが更新され、終了コード0で完了する
```
