...
Feature: RUNNING中の確報比較依頼の中止を依頼する
  ...
  Scenario: RUNNING中の確報比較依頼の中止を依頼する
    Given execution_specsテーブルにrun_id="e57a03c8-9d21-4b6f-8a34-1c7e5b9d206f"、job_id="daily-settlement"、job_map_version="v1.4.0"、hang_detect_limit_minutes=30の行が存在する
