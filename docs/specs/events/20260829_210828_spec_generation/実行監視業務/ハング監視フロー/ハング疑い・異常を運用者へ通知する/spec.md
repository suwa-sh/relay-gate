...
Feature: ハング疑い・異常を運用者へ通知する
  ...
  Scenario: 未通知のハング検知記録を運用者へ通知する
    ...
    And detection_id "b83f4d15-6c92-4e07-a5b8-3d19f7c04e2a" のハング検知記録が detection_type "ハング疑い"、run_id "3f8c9d2e-5b41-4a7e-9c13-6d2a8b0f1e57"、attempt_id "att-blue-0001"、threshold_minutes 30、slot_type "blue"、notified_atが未設定で存在する
    When CronJobが通知バッチトリガーで起動する
    Then detection_id "b83f4d15-6c92-4e07-a5b8-3d19f7c04e2a" のハング検知記録がHangDetectionNotice（banner）形式で運用者へ通知される
...
```gherkin
  Scenario: 通知送信の永続化失敗時はnotified_atを更新しない
    ...
    And detection_id "b83f4d15-6c92-4e07-a5b8-3d19f7c04e2a" のハング検知記録が run_id "3f8c9d2e-5b41-4a7e-9c13-6d2a8b0f1e57"、未通知で存在する
