export type Status = 'starting' | 'running' | 'succeeded' | 'failed' | 'unknown' | 'aborted' | 'requested' | 'claimed'
...
const style: Record<Status, { background: string; color: string }> = {
  starting: { background: 'var(--status-badge-starting-bg)', color: 'var(--status-badge-starting-fg)' },
  ...
  unknown: { background: 'var(--status-badge-unknown-bg)', color: 'var(--status-badge-unknown-fg)' },
