...
| 項目 | 内容 |
|------|------|
| Event ID | 20260817_153235_design_system + 20260817_180235_spec_stories + 20260818_143057_design_system + 20260818_162251_spec_stories + 20260819_113049_design_system + 20260819_125615_spec_stories + 20260829_220117_spec_stories |
| Created At | 2026-08-29T22:01:17+09:00 (最終更新) |
...
| 起動slot選択画面 | /cli/concurrent-run/select-slot | ExecutionSpecCard, RunnerResultPanel, Banner |
...
| 起動slot選択画面 | feature flag設定に基づきslotを選択して起動する | Pages/運用ポータル/起動slot選択画面 | ConcurrentModeDashboard, GreenSoloModeDashboard, BothForegroundRejectedDashboard, JobMapUnresolvedDashboard, JobMapFieldMissingDashboard, LaunchEventFailedDashboard, LaunchEventTimeoutDashboard, ConcurrentModeHeadless |
...
| 実行結果応答管理画面 | foreground roleの標準出力・標準エラー・終了コードを応答する | Pages/運用ポータル/実行結果応答管理画面 | SucceededDashboard, FailedDashboard, LaunchFailedDashboard, UnresolvedDashboard, UnknownDashboard, AbortedDashboard, ValidationErrorDashboard, SucceededHeadless |
