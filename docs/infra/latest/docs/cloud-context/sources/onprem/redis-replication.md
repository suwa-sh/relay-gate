...
::::::::::::::: {.docs .w-full .max-w-[1920px] .mx-auto .px-5 .flex .flex-col .md:flex-row .overflow-hidden role="main"}
::: {.md:block .w-full .md:w-96 .h-fit .md:h-full .shrink-0 .text-base .font-mono .font-normal .py-6}
:::

::::::::::: {.w-full .py-12 .md:pl-4 .xl:px-16 .overflow-hidden}
:::::::::: {.section .prose .w-full .py-12 .max-w-none}
# Redis replication

How Redis supports high availability and failover with replication

::: {.post-categories style="display: table;"}
  Redis Open Source
  -------------------
:::
...
### Important facts about Redis replication [![](data:image/svg+xml;base64,){.inline-block .w-4 .h-4 .align-baseline}](#important-facts-about-redis-replication "Copy link to clipboard"){.header-link .opacity-0 .group-hover:opacity-100 .transition-opacity .duration-200 .ml-1 .align-baseline aria-label="Link to this section"} {#important-facts-about-redis-replication .group .relative}
...
## Safety of replication when master has persistence turned off [![](data:image/svg+xml;base64,){.inline-block .w-4 .h-4 .align-baseline}](#safety-of-replication-when-master-has-persistence-turned-off "Copy link to clipboard"){.header-link .opacity-0 .group-hover:opacity-100 .transition-opacity .duration-200 .ml-1 .align-baseline aria-label="Link to this section"} {#safety-of-replication-when-master-has-persistence-turned-off .group .relative}
...
## How Redis replication works [![](data:image/svg+xml;base64,){.inline-block .w-4 .h-4 .align-baseline}](#how-redis-replication-works "Copy link to clipboard"){.header-link .opacity-0 .group-hover:opacity-100 .transition-opacity .duration-200 .ml-1 .align-baseline aria-label="Link to this section"} {#how-redis-replication-works .group .relative}
...
You can try it yourself via telnet. Connect to the Redis port while the server is doing some work and issue the [`SYNC`](/docs/latest/commands/sync/) command. You\'ll see a bulk transfer and then every command received by the master will be re-issued in the telnet session. Actually [`SYNC`](/docs/latest/commands/sync/) is an old protocol no longer used by newer Redis instances, but is still there for backward compatibility: it does not allow partial resynchronizations, so now [`PSYNC`](/docs/latest/commands/psync/) is used instead.
...
## Replication ID explained [![](data:image/svg+xml;base64,){.inline-block .w-4 .h-4 .align-baseline}](#replication-id-explained "Copy link to clipboard"){.header-link .opacity-0 .group-hover:opacity-100 .transition-opacity .duration-200 .ml-1 .align-baseline aria-label="Link to this section"} {#replication-id-explained .group .relative}
...
## Diskless replication [![](data:image/svg+xml;base64,){.inline-block .w-4 .h-4 .align-baseline}](#diskless-replication "Copy link to clipboard"){.header-link .opacity-0 .group-hover:opacity-100 .transition-opacity .duration-200 .ml-1 .align-baseline aria-label="Link to this section"} {#diskless-replication .group .relative}
...
## Configuration [![](data:image/svg+xml;base64,){.inline-block .w-4 .h-4 .align-baseline}](#configuration "Copy link to clipboard"){.header-link .opacity-0 .group-hover:opacity-100 .transition-opacity .duration-200 .ml-1 .align-baseline aria-label="Link to this section"} {#configuration .group .relative}

To configure basic Redis replication is trivial: just add the following line to the replica configuration file:

    replicaof 192.168.1.1 6379

Of course you need to replace 192.168.1.1 6379 with your master IP address (or hostname) and port. Alternatively, you can call the [`REPLICAOF`](/docs/latest/commands/replicaof/) command and the master host will start a sync with the replica.
...
## Read-only replica [![](data:image/svg+xml;base64,){.inline-block .w-4 .h-4 .align-baseline}](#read-only-replica "Copy link to clipboard"){.header-link .opacity-0 .group-hover:opacity-100 .transition-opacity .duration-200 .ml-1 .align-baseline aria-label="Link to this section"} {#read-only-replica .group .relative}

Since Redis 2.6, replicas support a read-only mode that is enabled by default. This behavior is controlled by the `replica-read-only` option in the redis.conf file, and can be enabled and disabled at runtime using [`CONFIG SET`](/docs/latest/commands/config-set/) .

Read-only replicas will reject all write commands, so that it is not possible to write to a replica because of a mistake. This does not mean that the feature is intended to expose a replica instance to the internet or more generally to a network where untrusted clients exist, because administrative commands like [`DEBUG`](/docs/latest/commands/debug/) or [`CONFIG`](/docs/latest/commands/config/) are still enabled. The [Security](/docs/latest/operate/oss_and_stack/management/security/) page describes how to secure a Redis instance.
...
- Computing slow Set or Sorted set operations and storing the result in temporary local keys using commands like [`SUNIONSTORE`](/docs/latest/commands/sunionstore/) and [`ZINTERSTORE`](/docs/latest/commands/zinterstore/) . Instead, use commands that return the result without storing it, such as [`SUNION`](/docs/latest/commands/sunion/) and [`ZINTER`](/docs/latest/commands/zinter/) .

- Using the [`SORT`](/docs/latest/commands/sort/) command (which is not considered a read-only command because of the optional STORE option and therefore cannot be used on a read-only replica). Instead, use [`SORT_RO`](/docs/latest/commands/sort_ro/) , which is a read-only command.

- Using [`EVAL`](/docs/latest/commands/eval/) and [`EVALSHA`](/docs/latest/commands/evalsha/) are also not considered read-only commands, because the Lua script may call write commands. Instead, use [`EVAL_RO`](/docs/latest/commands/eval_ro/) and [`EVALSHA_RO`](/docs/latest/commands/evalsha_ro/) where the Lua script can only call read-only commands.
...
## Setting a replica to authenticate to a master [![](data:image/svg+xml;base64,){.inline-block .w-4 .h-4 .align-baseline}](#setting-a-replica-to-authenticate-to-a-master "Copy link to clipboard"){.header-link .opacity-0 .group-hover:opacity-100 .transition-opacity .duration-200 .ml-1 .align-baseline aria-label="Link to this section"} {#setting-a-replica-to-authenticate-to-a-master .group .relative}
...
## Allow writes only with N attached replicas [![](data:image/svg+xml;base64,){.inline-block .w-4 .h-4 .align-baseline}](#allow-writes-only-with-n-attached-replicas "Copy link to clipboard"){.header-link .opacity-0 .group-hover:opacity-100 .transition-opacity .duration-200 .ml-1 .align-baseline aria-label="Link to this section"} {#allow-writes-only-with-n-attached-replicas .group .relative}
...
## How Redis replication deals with expires on keys [![](data:image/svg+xml;base64,){.inline-block .w-4 .h-4 .align-baseline}](#how-redis-replication-deals-with-expires-on-keys "Copy link to clipboard"){.header-link .opacity-0 .group-hover:opacity-100 .transition-opacity .duration-200 .ml-1 .align-baseline aria-label="Link to this section"} {#how-redis-replication-deals-with-expires-on-keys .group .relative}
...
1.  Replicas don\'t expire keys, instead they wait for masters to expire the keys. When a master expires a key (or evict it because of LRU), it synthesizes a [`DEL`](/docs/latest/commands/del/) command which is transmitted to all the replicas.
2.  However because of master-driven expire, sometimes replicas may still have in memory keys that are already logically expired, since the master was not able to provide the [`DEL`](/docs/latest/commands/del/) command in time. To deal with that the replica uses its logical clock to report that a key does not exist **only for read operations** that don\'t violate the consistency of the data set (as new commands from the master will arrive). In this way replicas avoid reporting logically expired keys that are still existing. In practical terms, an HTML fragments cache that uses replicas to scale will avoid returning items that are already older than the desired time to live.
...
## Configuring replication in Docker and NAT [![](data:image/svg+xml;base64,){.inline-block .w-4 .h-4 .align-baseline}](#configuring-replication-in-docker-and-nat "Copy link to clipboard"){.header-link .opacity-0 .group-hover:opacity-100 .transition-opacity .duration-200 .ml-1 .align-baseline aria-label="Link to this section"} {#configuring-replication-in-docker-and-nat .group .relative}

When Docker, or other types of containers using port forwarding, or Network Address Translation is used, Redis replication needs some extra care, especially when using Redis Sentinel or other systems where the master [`INFO`](/docs/latest/commands/info/) or [`ROLE`](/docs/latest/commands/role/) commands output is scanned to discover replicas\' addresses.

The problem is that the [`ROLE`](/docs/latest/commands/role/) command, and the replication section of the [`INFO`](/docs/latest/commands/info/) output, when issued into a master instance, will show replicas as having the IP address they use to connect to the master, which, in environments using NAT may be different compared to the logical address of the replica instance (the one that clients should use to connect to replicas).
...
## The INFO and ROLE command [![](data:image/svg+xml;base64,){.inline-block .w-4 .h-4 .align-baseline}](#the-info-and-role-command "Copy link to clipboard"){.header-link .opacity-0 .group-hover:opacity-100 .transition-opacity .duration-200 .ml-1 .align-baseline aria-label="Link to this section"} {#the-info-and-role-command .group .relative}

There are two Redis commands that provide a lot of information on the current replication parameters of master and replica instances. One is [`INFO`](/docs/latest/commands/info/) . If the command is called with the `replication` argument as `INFO replication` only information relevant to the replication are displayed. Another more computer-friendly command is [`ROLE`](/docs/latest/commands/role/) , that provides the replication status of masters and replicas together with their replication offsets, list of connected replicas and so forth.

## Partial sync after restarts and failovers [![](data:image/svg+xml;base64,){.inline-block .w-4 .h-4 .align-baseline}](#partial-sync-after-restarts-and-failovers "Copy link to clipboard"){.header-link .opacity-0 .group-hover:opacity-100 .transition-opacity .duration-200 .ml-1 .align-baseline aria-label="Link to this section"} {#partial-sync-after-restarts-and-failovers .group .relative}
...
Moreover, replicas - when powered off gently and restarted - are able to store in the `RDB` file the information needed to resync with their master. This is useful in case of upgrades. When this is needed, it is better to use the [`SHUTDOWN`](/docs/latest/commands/shutdown/) command in order to perform a `save & quit` operation on the replica.
...
## `Maxmemory` on replicas [![](data:image/svg+xml;base64,){.inline-block .w-4 .h-4 .align-baseline}](#maxmemory-on-replicas "Copy link to clipboard"){.header-link .opacity-0 .group-hover:opacity-100 .transition-opacity .duration-200 .ml-1 .align-baseline aria-label="Link to this section"} {#maxmemory-on-replicas .group .relative}
...
[Back to top ↑](#){.font-mono .no-underline}
:::::

::::: {#feedback-form .hidden}
:::: {.grid .gap-2}
::: {.cf-turnstile sitekey="0x4AAAAAABpkO-YRJzl4qTBW" callback="enableSubmit"}
:::
...
:::: {.section .hidden .xl:block .w-60 .h-full .shrink-0}
::: {.w-60 .z-40 .overflow-auto .fixed .top-28 .h-full .max-h-[calc(100vh-15rem)] .text-sm}
[![](data:image/svg+xml;base64,){.w-4 .h-4} Edit this page](https://github.com/redis/docs/edit/main/content/operate/oss_and_stack/management/replication.md){.group .inline-flex .items-center .gap-1 .hover:text-redis-pen-400 .mt-auto .self-start target="_blank"} [![](data:image/svg+xml;base64,){.w-4 .h-4} Create an issue](https://github.com/redis/docs/issues/new?title=Feedback:%20Redis%20replication&body=Page%20https://redis.io/docs/latest/operate/oss_and_stack/management/replication){.group .inline-flex .items-center .gap-1 .hover:text-redis-pen-400 .mt-auto .self-start target="_blank"}

![](data:image/svg+xml;base64,){.w-4 .h-4} Download documentation

[![](data:image/svg+xml;base64,) Ask AI to explain this page](/chat?q=Explain+this+Redis+documentation+page%3A+%22Redis+replication%22+%28https%3A%2F%2Fredis.io%2Fdocs%2Flatest%2Foperate%2Foss_and_stack%2Fmanagement%2Freplication%2F%29){.group .inline-flex .items-center .gap-1 .hover:text-redis-pen-400 .mt-auto .self-start}

## On this page {#on-this-page .font-medium .my-3}
:::
::::
:::::::::::::::
